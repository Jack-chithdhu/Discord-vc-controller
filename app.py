...
def init_db():
    ...
    try:
        ...
        with _cursor() as cur:
            ...
            """)
        print("[db] PostgreSQL ready (vc_logs, vc_lock_channels, vc_lock_members, join_requests, bot_settings, birthdays, birthday_nudges, points, vc_sessions, vc_reservations, doctor_temp_fixes).", flush=True)
        return True
