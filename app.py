...
def init_db():
    ...
    try:
        ...
        with _cursor() as cur:
            ...
            """)
        print("[db] PostgreSQL ready (vc_logs, vc_lock_channels, vc_lock_members, join_requests).", flush=True)
        return True
...
if not WHATSAPP_LINK:
    print("[join] WHATSAPP_LINK env var not set — approvals will DM an empty link.", flush=True)
...
async def ensure_join_button_posted():
    ...
    await channel.send(embed=embed, view=JoinButtonView())
